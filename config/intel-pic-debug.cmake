...
set(IRL_CXX_FLAGS "-g -O0 -debug all -ftrapuv -traceback -pedantic -Wall -Wextra -fPIC"
    CACHE STRING "C++ compile flags")

set(IRL_Fortran_FLAGS "-g -traceback -check all -check bounds -check uninit -ftrapuv -fPIC"
