// Cloned from https://github.com/libigl/triangle/blob/master/triangle.cpp
...
#else  /* not ANSI_DECLARATORS */
    int fast_expansion_sum_zeroelim(elen, e, flen, f,
                                    h) /* h cannot be e or f. */
    int elen;
REAL* e;
int flen;
REAL* f;
...
#else  /* not ANSI_DECLARATORS */
    int scale_expansion_zeroelim(elen, e, b,
                                 h) /* e and h cannot be the same. */
    int elen;
REAL* e;
REAL b;
REAL* h;
...
#ifdef ANSI_DECLARATORS
    REAL
    incircle(struct mesh* m, struct behavior* b, vertex pa, vertex pb,
             vertex pc, vertex pd)
#else  /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
    REAL
    orient3dadapt(vertex pa, vertex pb, vertex pc, vertex pd, REAL aheight,
...
#ifdef ANSI_DECLARATORS
    REAL
    orient3d(struct mesh* m, struct behavior* b, vertex pa, vertex pb,
...

{
  ...
  while (totalsamplesleft > 0) {
    ...
    firsttri = (char*)(alignptr + (INT_PTR)m->triangles.alignbytes -
                       (alignptr % (INT_PTR)m->triangles.alignbytes));
...
#ifdef ANSI_DECLARATORS
void triangulate_from_lib(char* triswitches, struct triangulateio* in,
                          struct triangulateio* out,
                          struct triangulateio* vorout)
#else  /* not ANSI_DECLARATORS */
  void triangulate_from_lib(triswitches, in, out, vorout) char* triswitches;
