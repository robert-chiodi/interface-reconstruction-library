...
void c_OptimizationBehavior_setAcceptableError(c_OptimizationBehavior* a_self,
...
void c_OptimizationBehavior_setMaxIterations(c_OptimizationBehavior* a_self,
                                             const int a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  assert(a_parameter >= 0);
  (*a_self->obj_ptr).maximum_iterations =
      static_cast<IRL::UnsignedIndex_t>(a_parameter);
}

void c_OptimizationBehavior_setMinAngleChange(c_OptimizationBehavior* a_self,
                                              const double a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
...
void c_OptimizationBehavior_setMinDistanceChange(c_OptimizationBehavior* a_self,
                                                 const double a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
...
void c_OptimizationBehavior_setLambdaIncrease(c_OptimizationBehavior* a_self,
                                              const double a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
...
void c_OptimizationBehavior_setLambdaDecrease(c_OptimizationBehavior* a_self,
                                              const double a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
...
void c_OptimizationBehavior_setDelayJacobianAmount(
    c_OptimizationBehavior* a_self, const int a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  assert(a_parameter >= 0);
  (*a_self->obj_ptr).delay_jacobian_amount =
      static_cast<IRL::UnsignedIndex_t>(a_parameter);
}

void c_OptimizationBehavior_setInitialAngle(c_OptimizationBehavior* a_self,
                                            const double a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
...
void c_OptimizationBehavior_setInitialDistance(c_OptimizationBehavior* a_self,
                                               const double a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
...
void c_OptimizationBehavior_setFiniteDifferenceAngle(
    c_OptimizationBehavior* a_self, const double a_parameter) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  (*a_self->obj_ptr).finite_difference_angle = a_parameter;
}

void c_OptimizationBehavior_getParameters(c_OptimizationBehavior* a_self,
                                          double* a_parameters) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  ...
  a_parameters[6] =
      static_cast<double>((*a_self->obj_ptr).delay_jacobian_amount);
