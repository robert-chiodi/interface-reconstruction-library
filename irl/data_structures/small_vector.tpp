...
#ifndef IRL_DATA_STRUCTURES_SMALL_VECTOR_TPP_
#define IRL_DATA_STRUCTURES_SMALL_VECTOR_TPP_
...
SmallVector<T, BuffSizeInElements>::SmallVector(
    const std::size_t a_initial_size)
...
template <class T, std::size_t BuffSizeInElements>
SmallVector<T, BuffSizeInElements>::SmallVector(
    const std::size_t a_initial_size, const T &a_value)
...
template <class T, std::size_t BuffSizeInElements>
T &SmallVector<T, BuffSizeInElements>::operator[](const std::size_t a_index) {
  return vector_m[a_index];
}

template <class T, std::size_t BuffSizeInElements>
const T &SmallVector<T, BuffSizeInElements>::
operator[](const std::size_t a_index) const {
  return vector_m[a_index];
}

template <class T, std::size_t BuffSizeInElements>
std::size_t SmallVector<T, BuffSizeInElements>::size(void) const {
  return vector_m.size();
}

template <class T, std::size_t BuffSizeInElements>
std::size_t SmallVector<T, BuffSizeInElements>::capacity(void) const {
  return vector_m.capacity();
}
...
template <class T, std::size_t BuffSizeInElements>
void SmallVector<T, BuffSizeInElements>::resize(const std::size_t a_count,
                                                T val) {
  vector_m.resize(a_count, val);
}

template <class T, std::size_t BuffSizeInElements>
void SmallVector<T, BuffSizeInElements>::reserve(const std::size_t a_count) {
  vector_m.reserve(a_count);
}

template <class T, std::size_t BuffSizeInElements>
void SmallVector<T, BuffSizeInElements>::assign(const std::size_t a_count,
                                                const T &a_value) {
