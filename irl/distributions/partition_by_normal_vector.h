...
#ifndef IRL_DISTRIBUTIONS_PARTITION_BY_NORMAL_VECTOR_H_
#define IRL_DISTRIBUTIONS_PARTITION_BY_NORMAL_VECTOR_H_
...
#include "irl/distributions/partition_by_normal_vector.tpp"

#endif // IRL_DISTRIBUTIONS_PARTITION_BY_NORMAL_VECTOR_H_
