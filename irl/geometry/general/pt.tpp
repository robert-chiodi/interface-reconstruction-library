...
template <class E> inline Pt::Pt(const Expr<E> &a_expr) {
  const E &expr(a_expr);
  loc_m[0] = expr[0];
  loc_m[1] = expr[1];
  loc_m[2] = expr[2];
...
template <class E> inline Pt::Pt(Expr<E> &&a_expr) {
  const E &expr(a_expr);
  loc_m[0] = expr[0];
  loc_m[1] = expr[1];
  loc_m[2] = expr[2];
...
template <class E> inline Pt &Pt::operator=(const Expr<E> &a_expr) {
  const E &expr(a_expr);
  loc_m[0] = expr[0];
  loc_m[1] = expr[1];
  loc_m[2] = expr[2];
...
template <class E> inline Pt &Pt::operator=(Expr<E> &&a_expr) {
  const E &expr(a_expr);
  loc_m[0] = expr[0];
  loc_m[1] = expr[1];
  loc_m[2] = expr[2];
