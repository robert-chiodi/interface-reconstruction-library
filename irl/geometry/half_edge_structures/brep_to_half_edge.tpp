...
#ifndef IRL_GEOMETRY_HALF_EDGE_STRUCTURES_BREP_TO_HALF_EDGE_TPP_
#define IRL_GEOMETRY_HALF_EDGE_STRUCTURES_BREP_TO_HALF_EDGE_TPP_
...
void BREPToHalfEdge<PtType, VertexType, HalfEdgeType, FaceType, kMaxHalfEdges,
  ...
  a_half_edge_version->resize(
      number_of_half_edges, static_cast<UnsignedIndex_t>(a_pt_container.size()),
