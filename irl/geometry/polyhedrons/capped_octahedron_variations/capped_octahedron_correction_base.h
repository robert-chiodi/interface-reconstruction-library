...
#ifndef IRL_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_CORRECTION_BASE_H_
#define IRL_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_CORRECTION_BASE_H_
...
class CappedOctahedronCorrectionBase: public BasePolyhedron<Derived, VertexType, ProxyTet<Derived>> {
...
#include "irl/geometry/polyhedrons/capped_octahedron_variations/capped_octahedron_correction_base.tpp"
