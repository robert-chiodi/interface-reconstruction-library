...
#ifndef IRL_GEOMETRY_POLYHEDRONS_SYMMETRIC_DECOMPOSITIONS_SYMMETRIC_TET_H_
#define IRL_GEOMETRY_POLYHEDRONS_SYMMETRIC_DECOMPOSITIONS_SYMMETRIC_TET_H_
...
#include "irl/geometry/polyhedrons/symmetric_decompositions/symmetric_tet.tpp"
