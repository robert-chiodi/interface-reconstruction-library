...
#ifndef IRL_GEOMETRY_POLYHEDRONS_SYMMETRIC_DECOMPOSITIONS_SYMMETRIC_TRIANGULAR_PRISM_H_
#define IRL_GEOMETRY_POLYHEDRONS_SYMMETRIC_DECOMPOSITIONS_SYMMETRIC_TRIANGULAR_PRISM_H_
...
class SymmetricTriangularPrismSpecialization: public BasePolyhedron<Derived, VertexType, ProxyTet<Derived>> {
public: 
...
#include "irl/geometry/polyhedrons/symmetric_decompositions/symmetric_triangular_prism.tpp"
