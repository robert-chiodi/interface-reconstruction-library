...
#ifndef IRL_HELPERS_EXPRESSION_TEMPLATES_TPP_
#define IRL_HELPERS_EXPRESSION_TEMPLATES_TPP_
...
template <typename V1, typename V2>
typename vector_subtract<V1, V2>::value_type
vector_subtract<V1, V2>::operator[](const UnsignedIndex_t i) const {
  static_assert(
      std::is_same<typename V1::value_type, typename V2::value_type>::value,
      "Trying to substract two vectors with different value types. This is "
      "forbidden.");
...
vector_scale<V1>::vector_scale(const typename V1::value_type a_scalar,
                               const V1& a_v1)
...
template <typename V1, typename V2>
vector_cross_product<V1, V2>::vector_cross_product(const V1& a_v1,
                                                   const V2& a_v2)
    : v1_m(a_v1), v2_m(a_v2) {
  static_assert(
      std::is_same<typename V1::value_type, typename V2::value_type>::value,
...
template <typename V1, typename V2>
typename vector_cross_product<V1, V2>::value_type
vector_cross_product<V1, V2>::operator[](const UnsignedIndex_t i) const {
  static_assert(
      std::is_same<typename V1::value_type, typename V2::value_type>::value,
      "Trying to cross two vectors with different value types. This is "
      "forbidden.");
...
#endif  // IRL_HELPERS_EXPRESSION_TEMPLATES_TPP_
