...
#ifndef IRL_INTERFACE_RECONSTRUCTION_METHODS_ADVECTED_PLANE_RECONSTRUCTION_TPP_
#define IRL_INTERFACE_RECONSTRUCTION_METHODS_ADVECTED_PLANE_RECONSTRUCTION_TPP_
...
PlanarSeparator AdvectedPlaneReconstruction::constructSeparatorAttempt(
  ...
  IterativeSolverForDistance<ReconstructionDefaultCuttingMethod, CellType>
      solver(a_cell, a_target_volume_fraction,
