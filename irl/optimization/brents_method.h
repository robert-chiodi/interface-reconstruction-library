...
#ifndef IRL_OPTIMIZATION_BRENTS_METHOD_H_
#define IRL_OPTIMIZATION_BRENTS_METHOD_H_
...
#include "irl/optimization/brents_method.tpp"

#endif // IRL_OPTIMIZATION_BRENTS_METHOD_H_
