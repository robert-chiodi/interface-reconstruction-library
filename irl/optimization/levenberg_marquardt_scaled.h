...
#ifndef IRL_OPTIMIZATION_LEVENBERG_MARQUARDT_SCALED_H_
#define IRL_OPTIMIZATION_LEVENBERG_MARQUARDT_SCALED_H_
...
// Overload of LevenbergMarquardtScaled class that requires run time setting of
// matrix rows.
template <class OptimizingClass, int kColumns> class LevenbergMarquardtScaled {
public:
  /// \brief Default construction
  LevenbergMarquardtScaled(void);
  ...
  ~LevenbergMarquardtScaled(void) = default;
...
#include "irl/optimization/levenberg_marquardt_scaled.tpp"

#endif // SRC_OPTIMIZATION_LEVENBERG_MARQUARDT_SCALED_H_
