...
#ifndef IRL_PLANAR_RECONSTRUCTION_LOCALIZED_SEPARATOR_GROUP_LINK_H_
#define IRL_PLANAR_RECONSTRUCTION_LOCALIZED_SEPARATOR_GROUP_LINK_H_
...
#endif // IRL_PLANAR_RECONSTRUCTION_LOCALIZED_SEPARATOR_GROUP_LINK_H_
