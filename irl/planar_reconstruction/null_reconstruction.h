...
#ifndef IRL_PLANAR_RECONSTRUCTION_NULL_RECONSTRUCTION_H_
#define IRL_PLANAR_RECONSTRUCTION_NULL_RECONSTRUCTION_H_
...
#endif // IRL_PLANAR_RECONSTRUCTION_NULL_RECONSTRUCTION_H_
