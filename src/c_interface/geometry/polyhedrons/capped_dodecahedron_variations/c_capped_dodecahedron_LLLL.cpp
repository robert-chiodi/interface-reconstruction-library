...
void c_CapDod_LLLL_new(c_CapDod_LLLL* a_self) {
  ...
  a_self->obj_ptr = new IRL::CappedDodecahedron_LLLL;
}
...
void c_CapDod_LLLL_construct(c_CapDod_LLLL* a_self, const double* a_capped_dodecahedron) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  *a_self->obj_ptr =
      IRL::CappedDodecahedron_LLLL::fromRawDoublePointer(9, a_capped_dodecahedron);
}
