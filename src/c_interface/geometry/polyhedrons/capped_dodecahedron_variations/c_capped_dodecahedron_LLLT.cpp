...
void c_CapDod_LLLT_new(c_CapDod_LLLT* a_self) {
  ...
  a_self->obj_ptr = new IRL::CappedDodecahedron_LLLT;
}
...
void c_CapDod_LLLT_construct(c_CapDod_LLLT* a_self, const double* a_capped_dodecahedron) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  *a_self->obj_ptr =
      IRL::CappedDodecahedron_LLLT::fromRawDoublePointer(9, a_capped_dodecahedron);
}
