...
#ifndef SRC_C_INTERFACE_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_C_CAPPED_DODECAHEDRON_LLTT_H_
#define SRC_C_INTERFACE_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_C_CAPPED_DODECAHEDRON_LLTT_H_

#include "src/geometry/polyhedrons/capped_dodecahedron_variations/capped_dodecahedron_LLTT.h"

extern "C" {

struct c_CapDod_LLTT {
  IRL::CappedDodecahedron_LLTT* obj_ptr = nullptr;
};

void c_CapDod_LLTT_new(c_CapDod_LLTT* a_self);
void c_CapDod_LLTT_delete(c_CapDod_LLTT* a_self);
void c_CapDod_LLTT_construct(c_CapDod_LLTT* a_self, const double* a_dodecahedron);
...
#endif  // SRC_C_INTERFACE_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_C_CAPPED_DODECAHEDRON_LLTT_H_
