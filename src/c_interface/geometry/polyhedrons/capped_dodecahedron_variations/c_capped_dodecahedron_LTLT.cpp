...
void c_CapDod_LTLT_new(c_CapDod_LTLT* a_self) {
  ...
  a_self->obj_ptr = new IRL::CappedDodecahedron_LTLT;
}
...
void c_CapDod_LTLT_construct(c_CapDod_LTLT* a_self, const double* a_capped_dodecahedron) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  *a_self->obj_ptr =
      IRL::CappedDodecahedron_LTLT::fromRawDoublePointer(9, a_capped_dodecahedron);
}
