...
void c_CapDod_LTTT_new(c_CapDod_LTTT* a_self) {
  ...
  a_self->obj_ptr = new IRL::CappedDodecahedron_LTTT;
}
...
void c_CapDod_LTTT_construct(c_CapDod_LTTT* a_self, const double* a_capped_dodecahedron) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  *a_self->obj_ptr =
      IRL::CappedDodecahedron_LTTT::fromRawDoublePointer(9, a_capped_dodecahedron);
}
