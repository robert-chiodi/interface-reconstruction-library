...
void c_CapOcta_LLT_new(c_CapOcta_LLT* a_self) {
  ...
  a_self->obj_ptr = new IRL::CappedOctahedron_LLT;
}
...
void c_CapOcta_LLT_construct(c_CapOcta_LLT* a_self, const double* a_capped_octahedron) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  *a_self->obj_ptr =
      IRL::CappedOctahedron_LLT::fromRawDoublePointer(7, a_capped_octahedron);
}
