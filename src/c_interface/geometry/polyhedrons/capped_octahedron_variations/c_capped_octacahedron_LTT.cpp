...
void c_CapOcta_LTT_new(c_CapOcta_LTT* a_self) {
  ...
  a_self->obj_ptr = new IRL::CappedOctahedron_LTT;
}
...
void c_CapOcta_LTT_construct(c_CapOcta_LTT* a_self, const double* a_capped_octahedron) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  *a_self->obj_ptr =
      IRL::CappedOctahedron_LTT::fromRawDoublePointer(7, a_capped_octahedron);
}
