...
void c_CapOcta_TTT_new(c_CapOcta_TTT* a_self) {
  ...
  a_self->obj_ptr = new IRL::CappedOctahedron_TTT;
}
...
void c_CapOcta_TTT_construct(c_CapOcta_TTT* a_self, const double* a_capped_octahedron) {
  assert(a_self != nullptr);
  assert(a_self->obj_ptr != nullptr);
  *a_self->obj_ptr =
      IRL::CappedOctahedron_TTT::fromRawDoublePointer(7, a_capped_octahedron);
}
