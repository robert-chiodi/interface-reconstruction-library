...
#ifndef SRC_GEOMETRY_POLYHEDRONS_BASE_POLYHEDRON_H_
#define SRC_GEOMETRY_POLYHEDRONS_BASE_POLYHEDRON_H_
...
#include "src/geometry/polyhedrons/base_polyhedron.tpp"

#endif  // SRC_GEOMETRY_POLYHEDRONS_BASE_POLYHEDRON_H_
