...
#ifndef SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_LLLT_TPP_
#define SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_LLLT_TPP_
...
namespace capped_dodecahedron_LLLT_triangulation {
static constexpr UnsignedIndex_t datum_index = 7;
...
HalfEdgePolyhedron<VertexType> CappedDodecahedron_LLLTSpecialization<
...
void CappedDodecahedron_LLLTSpecialization<Derived, VertexType>::
  ...
  static constexpr std::array<UnsignedIndex_t, 40> ending_vertex_mapping{
      {8, 6, 5, 4, 8, 5, 8, 4, 7, 6, 8, 7, 1, 2, 3, 0, 5, 1, 0, 4,
       5, 0, 5, 6, 1, 6, 2, 1, 6, 7, 2, 7, 3, 2, 3, 7, 0, 7, 4, 0}};
  ...
  static constexpr std::array<UnsignedIndex_t, 40> opposite_half_edge_mapping{
      {5,  10, 23, 20, 7,  0,  11, 4,  38, 29, 1,  6,  18, 27,
       33, 34, 21, 22, 12, 39, 3,  16, 17, 2,  25, 24, 28, 13,
       26, 9,  31, 30, 35, 14, 15, 32, 37, 36, 8,  19}};
...
template <class Derived, class VertexType>
constexpr UnsignedIndex_t CappedDodecahedron_LLLTSpecialization<
    Derived, VertexType>::getNumberOfSimplicesInDecomposition(void) {
  return static_cast<UnsignedIndex_t>(
      capped_dodecahedron_LLLT_triangulation::face_triangle_decomposition
          .size());
}

template <class Derived, class VertexType>
constexpr std::array<UnsignedIndex_t, 4>
CappedDodecahedron_LLLTSpecialization<Derived, VertexType>::
    getSimplexIndicesFromDecomposition(const UnsignedIndex_t a_tet) {
  assert(a_tet < CappedDodecahedron_LLLTSpecialization::
                     getNumberOfSimplicesInDecomposition());
  return {
      capped_dodecahedron_LLLT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [0],
      capped_dodecahedron_LLLT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [1],
      capped_dodecahedron_LLLT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [2],
      capped_dodecahedron_LLLT_triangulation::datum_index};
}

template <class Derived, class VertexType>
ProxyTet<Derived> CappedDodecahedron_LLLTSpecialization<Derived, VertexType>::
...
#endif  // SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_LLLT_TPP_
