...
#ifndef SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_LTTT_TPP_
#define SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_LTTT_TPP_
...
namespace capped_dodecahedron_LTTT_triangulation {
...
HalfEdgePolyhedron<VertexType> CappedDodecahedron_LTTTSpecialization<
...
void CappedDodecahedron_LTTTSpecialization<Derived, VertexType>::
  ...
  static constexpr std::array<UnsignedIndex_t, 40> ending_vertex_mapping{
      {8, 6, 5, 4, 8, 5, 8, 4, 7, 6, 8, 7, 1, 2, 3, 0, 5, 1, 0, 4,
       5, 0, 1, 5, 2, 5, 6, 2, 3, 2, 6, 7, 3, 6, 3, 7, 0, 7, 4, 0}};
  ...
  static constexpr std::array<UnsignedIndex_t, 40> opposite_half_edge_mapping{
      {5,  10, 26, 20, 7,  0,  11, 4,  38, 31, 1,  6,  18, 22,
       29, 34, 21, 23, 12, 39, 3,  16, 13, 17, 25, 24, 2,  30,
       33, 14, 27, 9,  35, 28, 15, 32, 37, 36, 8,  19}};
...
template <class Derived, class VertexType>
constexpr UnsignedIndex_t CappedDodecahedron_LTTTSpecialization<
    Derived, VertexType>::getNumberOfSimplicesInDecomposition(void) {
  return static_cast<UnsignedIndex_t>(
      capped_dodecahedron_LTTT_triangulation::face_triangle_decomposition
          .size());
}

template <class Derived, class VertexType>
constexpr std::array<UnsignedIndex_t, 4>
CappedDodecahedron_LTTTSpecialization<Derived, VertexType>::
    getSimplexIndicesFromDecomposition(const UnsignedIndex_t a_tet) {
  assert(a_tet < CappedDodecahedron_LTTTSpecialization::
                     getNumberOfSimplicesInDecomposition());
  return {
      capped_dodecahedron_LTTT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [0],
      capped_dodecahedron_LTTT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [1],
      capped_dodecahedron_LTTT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [2],
      capped_dodecahedron_LTTT_triangulation::datum_index};
}

template <class Derived, class VertexType>
ProxyTet<Derived> CappedDodecahedron_LTTTSpecialization<Derived, VertexType>::
...
#endif  // SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_LTTT_TPP_
