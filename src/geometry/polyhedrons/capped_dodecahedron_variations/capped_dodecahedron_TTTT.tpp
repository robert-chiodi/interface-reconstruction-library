...
#ifndef SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_TTTT_TPP_
#define SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_TTTT_TPP_
...
namespace capped_dodecahedron_TTTT_triangulation {
...
HalfEdgePolyhedron<VertexType> CappedDodecahedron_TTTTSpecialization<
...
void CappedDodecahedron_TTTTSpecialization<Derived, VertexType>::
  ...
  static constexpr std::array<UnsignedIndex_t, 40> ending_vertex_mapping{
      {8, 6, 5, 4, 8, 5, 8, 4, 7, 6, 8, 7, 1, 2, 3, 0, 0, 4, 1, 4,
       5, 1, 1, 5, 2, 5, 6, 2, 3, 2, 6, 7, 3, 6, 3, 7, 0, 7, 4, 0}};
  ...
  static constexpr std::array<UnsignedIndex_t, 40> opposite_half_edge_mapping{
      {5,  10, 26, 20, 7,  0,  11, 4,  38, 31, 1,  6,  16, 22,
       29, 34, 12, 39, 19, 18, 3,  23, 13, 21, 25, 24, 2,  30,
       33, 14, 27, 9,  35, 28, 15, 32, 37, 36, 8,  17}};
...
template <class Derived, class VertexType>
constexpr UnsignedIndex_t CappedDodecahedron_TTTTSpecialization<
    Derived, VertexType>::getNumberOfSimplicesInDecomposition(void) {
  return static_cast<UnsignedIndex_t>(
      capped_dodecahedron_TTTT_triangulation::face_triangle_decomposition
          .size());
}

template <class Derived, class VertexType>
constexpr std::array<UnsignedIndex_t, 4>
CappedDodecahedron_TTTTSpecialization<Derived, VertexType>::
    getSimplexIndicesFromDecomposition(const UnsignedIndex_t a_tet) {
  assert(a_tet < CappedDodecahedron_TTTTSpecialization::
                     getNumberOfSimplicesInDecomposition());
  return {
      capped_dodecahedron_TTTT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [0],
      capped_dodecahedron_TTTT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [1],
      capped_dodecahedron_TTTT_triangulation::face_triangle_decomposition[a_tet]
                                                                         [2],
      capped_dodecahedron_TTTT_triangulation::datum_index};
}

template <class Derived, class VertexType>
ProxyTet<Derived> CappedDodecahedron_TTTTSpecialization<Derived, VertexType>::
...
#endif  // SRC_GEOMETRY_POLYHEDRONS_CAPPED_DODECAHEDRON_VARIATIONS_CAPPED_DODECAHEDRON_TTTT_TPP_
