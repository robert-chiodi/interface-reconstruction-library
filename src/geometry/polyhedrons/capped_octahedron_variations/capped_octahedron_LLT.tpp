...
#ifndef SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_LLT_TPP_
#define SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_LLT_TPP_
...
namespace capped_octahedron_LLT_triangulation {
static constexpr UnsignedIndex_t datum_index = 5;
static constexpr std::array<std::array<UnsignedIndex_t, 3>, 4>
    face_triangle_decomposition{{{0, 1, 2}, {6, 4, 3}, {0, 4, 1}, {0, 3, 4}}};
}  // namespace capped_octahedron_LLT_triangulation

template <class Derived, class VertexType>
HalfEdgePolyhedron<VertexType> CappedOctahedron_LLTSpecialization<
...
void CappedOctahedron_LLTSpecialization<Derived, VertexType>::
  ...
  static constexpr std::array<UnsignedIndex_t, 30> opposite_half_edge_mapping{
      {14, 23, 26, 11, 16, 6,  5,  27, 9, 8,  19, 3, 17, 18, 0,
       28, 4,  12, 13, 10, 21, 20, 24, 1, 22, 29, 2, 7,  15, 25}};
...
template <class Derived, class VertexType>
constexpr UnsignedIndex_t CappedOctahedron_LLTSpecialization<
    Derived, VertexType>::getNumberOfSimplicesInDecomposition(void) {
  return static_cast<UnsignedIndex_t>(
      capped_octahedron_LLT_triangulation::face_triangle_decomposition.size());
}

template <class Derived, class VertexType>
constexpr std::array<UnsignedIndex_t, 4>
CappedOctahedron_LLTSpecialization<Derived, VertexType>::
    getSimplexIndicesFromDecomposition(const UnsignedIndex_t a_tet) {
  assert(a_tet < CappedOctahedron_LLTSpecialization::
                     getNumberOfSimplicesInDecomposition());
  return {
      capped_octahedron_LLT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [0],
      capped_octahedron_LLT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [1],
      capped_octahedron_LLT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [2],
      capped_octahedron_LLT_triangulation::datum_index};
}

template <class Derived, class VertexType>
ProxyTet<Derived> CappedOctahedron_LLTSpecialization<Derived, VertexType>::
...
#endif  // SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_LLT_TPP_
