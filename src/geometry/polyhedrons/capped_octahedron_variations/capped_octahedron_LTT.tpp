...
#ifndef SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_LTT_TPP_
#define SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_LTT_TPP_
...
namespace capped_octahedron_LTT_triangulation {
static constexpr UnsignedIndex_t datum_index = 4;
static constexpr std::array<std::array<UnsignedIndex_t, 3>, 4>
    face_triangle_decomposition{{{0, 1, 2}, {6, 3, 5}, {2, 5, 0}, {5, 3, 0}}};
}  // namespace capped_octahedron_LTT_triangulation

template <class Derived, class VertexType>
HalfEdgePolyhedron<VertexType> CappedOctahedron_LTTSpecialization<
...
void CappedOctahedron_LTTSpecialization<Derived, VertexType>::
  ...
  static constexpr std::array<UnsignedIndex_t, 30> opposite_half_edge_mapping{
      {14, 19, 26, 11, 16, 6,  5,  27, 9,  8,  21, 3, 17, 20, 0,
       28, 4,  12, 23, 1,  13, 10, 24, 18, 22, 29, 2, 7,  15, 25}};
...
template <class Derived, class VertexType>
constexpr UnsignedIndex_t CappedOctahedron_LTTSpecialization<
    Derived, VertexType>::getNumberOfSimplicesInDecomposition(void) {
  return static_cast<UnsignedIndex_t>(
      capped_octahedron_LTT_triangulation::face_triangle_decomposition.size());
}

template <class Derived, class VertexType>
constexpr std::array<UnsignedIndex_t, 4>
CappedOctahedron_LTTSpecialization<Derived, VertexType>::
    getSimplexIndicesFromDecomposition(const UnsignedIndex_t a_tet) {
  assert(a_tet < CappedOctahedron_LTTSpecialization::
                     getNumberOfSimplicesInDecomposition());
  return {
      capped_octahedron_LTT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [0],
      capped_octahedron_LTT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [1],
      capped_octahedron_LTT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [2],
      capped_octahedron_LTT_triangulation::datum_index};
}

template <class Derived, class VertexType>
ProxyTet<Derived> CappedOctahedron_LTTSpecialization<Derived, VertexType>::
...
#endif  // SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_LTT_TPP_
