...
#ifndef SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_TTT_TPP_
#define SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_TTT_TPP_
...
namespace capped_octahedron_TTT_triangulation {
...
static constexpr std::array<std::array<UnsignedIndex_t, 3>, 5>
    face_triangle_decomposition{
        {{0, 1, 2}, {6, 5, 4}, {4, 2, 1}, {4, 5, 2}, {2, 5, 0}}};
}  // namespace capped_octahedron_TTT_triangulation

template <class Derived, class VertexType>
HalfEdgePolyhedron<VertexType> CappedOctahedron_TTTSpecialization<
...
void CappedOctahedron_TTTSpecialization<Derived, VertexType>::
  ...
  static constexpr std::array<UnsignedIndex_t, 30> ending_vertex_mapping{
      {1, 2, 0, 4, 3, 6, 3, 5, 6, 5, 4, 6, 3, 4, 1,
       0, 3, 1, 2, 1, 4, 5, 2, 4, 5, 0, 2, 3, 0, 5}};
  ...
  static constexpr std::array<UnsignedIndex_t, 30> opposite_half_edge_mapping{
      {15, 19, 26, 11, 13, 6,  5,  27, 9,  8,  21, 3, 17, 4,  20,
       0,  28, 12, 23, 1,  14, 10, 24, 18, 22, 29, 2, 7,  16, 25}};
...
template <class Derived, class VertexType>
constexpr UnsignedIndex_t CappedOctahedron_TTTSpecialization<
    Derived, VertexType>::getNumberOfSimplicesInDecomposition(void) {
  return static_cast<UnsignedIndex_t>(
      capped_octahedron_TTT_triangulation::face_triangle_decomposition.size());
}

template <class Derived, class VertexType>
constexpr std::array<UnsignedIndex_t, 4>
CappedOctahedron_TTTSpecialization<Derived, VertexType>::
    getSimplexIndicesFromDecomposition(const UnsignedIndex_t a_tet) {
  assert(a_tet < CappedOctahedron_TTTSpecialization::
                     getNumberOfSimplicesInDecomposition());
  return {
      capped_octahedron_TTT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [0],
      capped_octahedron_TTT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [1],
      capped_octahedron_TTT_triangulation::face_triangle_decomposition[a_tet]
                                                                      [2],
      capped_octahedron_TTT_triangulation::datum_index};
}

template <class Derived, class VertexType>
ProxyTet<Derived> CappedOctahedron_TTTSpecialization<Derived, VertexType>::
...
#endif  // SRC_GEOMETRY_POLYHEDRONS_CAPPED_OCTAHEDRON_VARIATIONS_CAPPED_OCTAHEDRON_TTT_TPP_
