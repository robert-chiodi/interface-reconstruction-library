...
static inline double sumVolumeFraction(
...
inline void runIterativeSolverForDistance(
  ...
  while (true) {
    ...
    IterativeSolverForDistance<decltype(split_cell)> solver(
        split_cell, scaled_volume_fraction, a_volume_fraction_tolerance,
