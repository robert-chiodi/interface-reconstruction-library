...
#ifndef SRC_OPTIMIZATION_BISECTION_H_
#define SRC_OPTIMIZATION_BISECTION_H_
...
namespace IRL {
/// \brief A templated class driver that performs bisection.
///
/// This class is a general bisection solver
...
/// `setGuess()` called in `this->calculateError()`.
///
...
class Bisection {
 public:
  ...
  void solve(OptimizingClass* a_otype, double a_bracket_0, double a_bracket_1,
             const UnsignedIndex_t a_max_iter = 100000000);

  /// \brief Default destructor
  ~Bisection(void) = default;
...
#include "src/optimization/bisection.tpp"

#endif  // SRC_OPTIMIZATION_BISECTION_H_
