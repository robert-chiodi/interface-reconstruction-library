...
#ifndef SRC_OPTIMIZATION_LEVENBERG_MARQUARDT_SCALED_H_
#define SRC_OPTIMIZATION_LEVENBERG_MARQUARDT_SCALED_H_
...
#include "src/optimization/levenberg_marquardt_scaled.tpp"
