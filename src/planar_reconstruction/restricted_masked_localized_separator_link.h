...
#ifndef SRC_PLANAR_RECONSTRUCTION_RESTRICTED_MASKED_LOCALIZED_SEPARATOR_LINK_H_
#define SRC_PLANAR_RECONSTRUCTION_RESTRICTED_MASKED_LOCALIZED_SEPARATOR_LINK_H_
...
#include "src/planar_reconstruction/restricted_masked_localized_separator_link.tpp"

#endif  // SRC_PLANAR_RECONSTRUCTION_RESTRICTED_MASKED_LOCALIZED_SEPARATOR_LINK_H_
