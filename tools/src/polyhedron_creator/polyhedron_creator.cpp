...
void PolyhedronCreator::writeHeaderDependencies(void) {
  ...
  header_file_m
      ...
      << std::endl;
  header_file_m << "#include \"irl/geometry/polyhedrons/general_polyhedron.h\""
                << std::endl;
  header_file_m << "#include \"irl/geometry/polyhedrons/tet.h\"" << std::endl;
  header_file_m << "#include \"irl/parameters/defined_types.h\"" << std::endl;
...
void PolyhedronCreator::writeTPPIncludes(void) {
  ...
  implementation_file_m
      << "#include "
         "\"irl/geometry/general/moment_calculation_through_simplices.h\""
      << std::endl;
  implementation_file_m
